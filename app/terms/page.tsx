...
export const metadata: Metadata = {
  title: siteData.meta.terms.title,
  description: siteData.meta.terms.description,
  keywords: siteData.meta.terms.keywords,
  alternates: { canonical: siteData.meta.terms.canonical },
  openGraph: {
    title: siteData.meta.terms.title,
    description: siteData.meta.terms.description,
    url: siteData.meta.terms.canonical,
    siteName: siteData.product.name,
    images: [{ url: siteData.meta.terms.ogImage, width: 1200, height: 630 }],
    locale: "en_US",
    type: "article",
  },
  twitter: {
    ...
    title: siteData.meta.terms.title,
    description: siteData.meta.terms.description,
    images: [siteData.meta.terms.ogImage],
  },
  robots: { index: true, follow: true },
};

export default function TermsPage() {
  const terms = siteData.subpages.terms;
  ...
  return (
    <>
      ...
      <LegalHero kicker={terms.kicker} title={terms.title}>
